...
class TrainPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifat: DataIngestionArtifact) -> DataValidationArtifact:
        logging.info("Entered the start_data_validation method of TrainingPipeline class")
        
        try:
            data_validation = DataValidation(
                data_ingestion_artifact=data_ingestion_artifat,
    ...
    def run_pipeline(self) -> None:
        try: 
            ...
            data_validation_artifact = self.start_data_validation(
                data_ingestion_artifat=data_ingestion_artifact
            )
            ...
            if data_validation_artifact.validation_status == True:
                ...
                raise Exception("Your data is no in correct format")
