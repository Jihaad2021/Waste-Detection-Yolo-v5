...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        ...
        try: 
            ...
            os.system(f"cp yolov5/runs/train/yolo5vs_results/weights/best.pt {self.model_trainer_config.model_trainer_dir}/")
            ...
            logging.info("Exited intiate_model_trainer method of ModelTrainer class")
